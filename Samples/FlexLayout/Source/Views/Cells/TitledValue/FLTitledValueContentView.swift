...
class FLTitledValueContentView: NiblessView,
                                UIContentView {
    ...
    private let valueView = FLSingleValueView()
    private let accessoryView = FLValueAccessoryView()
    
    var appliedConfiguration = FLTitledValueContentConfiguration(uid: UUID(),
    ...
    var configuration: UIContentConfiguration {
        ...
        set {
            guard let newConfig = newValue as? FLTitledValueContentConfiguration else { return }
    ...
    private func apply(configuration: FLTitledValueContentConfiguration) {
    ...
    func updateAccessoryViews() {
        accessoryView.appliedConfiguration = FLValueAccessoryConfiguration(delegate: appliedConfiguration.delegate,
                                                                           ...
                                                                           validationText: data.validationErrorText,
